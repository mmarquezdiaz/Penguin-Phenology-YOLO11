...
Los modelos personalizados se realizaron con diferente aumento de datos en el Laboratorio Nacional de Computación de Alto Rendimiento (NLHPC), cluster Guacolda, partición v100 (ya que cuenta con tarjeta NVIDIA), 1 nodo y 9 CPU.
